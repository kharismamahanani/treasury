...
<div class="left-panel">
  <div class="left-content">
    ...
    <div class="um-logo-wrap">
      @if(file_exists(public_path('images/logo-um.png')))
        <img src="{{ asset('images/logo-um.png') }}" alt="Logo UM">
      @else
  ...
  <div class="left-footer">&copy; {{ date('Y') }} Universitas Negeri Malang — Sistem Informasi Keuangan Internal</div>
</div>
...
<div class="right-panel">
  ...
  <form action="{{ route('login.post') }}" method="POST" style="width:100%">
    ...
    <div class="field">
      ...
      <input type="text" name="username" value="{{ old('username') }}" placeholder="Masukkan username" autocomplete="username" required autofocus>
    </div>
    <div class="field">
