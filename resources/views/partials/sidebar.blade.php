<nav class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    <div class="brand">
      {{-- Logo UM: ganti src dengan path logo resmi, mis: /images/logo-um.png --}}
      <div class="brand-icon" style="background:none;padding:2px;border-radius:8px;overflow:hidden;width:40px;height:40px">
        @if(file_exists(public_path('images/logo-um.png')))
          <img src="{{ asset('images/logo-um.png') }}" alt="UM" style="width:100%;height:100%;object-fit:contain">
        @else
          {{-- Placeholder monogram UM sampai logo diunggah --}}
