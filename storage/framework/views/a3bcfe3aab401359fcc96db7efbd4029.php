...
<div class="document">
  ...
  <div class="kop">
    ...
    <h3>Per <?php echo e(\Carbon\Carbon::parse($tanggal)->isoFormat('D MMMM YYYY')); ?></h3>
  ...
  <table class="laporan">
    ...
    <thead>
      <tr class="col-header">
        ...
        <th style="width:14%">Saldo (<?php echo e($currency); ?>)</th>
        <th style="width:6%">Rate Bunga</th>
      </tr>
    </thead>
    <tbody>
      <?php
      ...
      <?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr class="kat-row">
          <td colspan="8"><?php echo e($group['label']); ?></td>
        </tr>

        <?php $no = 1; ?>
        <?php $__currentLoopData = $group['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr class="data-row">
            <td class="text-center"><?php echo e($no++); ?></td>
            <td class="text-left" style="font-family:monospace;font-size:9pt"><?php echo e($p->account_number ?? '-'); ?></td>
            <td class="text-left"><?php echo e($p->nama_rekening ?? '-'); ?></td>
            <td class="text-center"><?php echo e($p->bank->code ?? '-'); ?></td>
            <td class="text-left"><?php echo e($p->bank->name ?? '-'); ?><?php echo e($p->bank->branch ? ' — '.$p->bank->branch : ''); ?></td>
            <td class="text-center"><?php echo e($p->balance_date ?? '-'); ?></td>
            <td class="text-right">
              <?php if($p->balance_display !== null): ?>
                Rp&nbsp;<?php echo e(number_format($p->balance_display, 2, ',', '.')); ?>
            ...
            <td class="text-center">
              <?php echo e($p->yield_rate_display ? number_format($p->yield_rate_display, 4).'%' : '—'); ?>
        ...
        <tr class="subtotal-row">
          <td colspan="6" class="text-right"><strong>Subtotal <?php echo e($group['label']); ?></strong></td>
          <td class="text-right">Rp&nbsp;<?php echo e(number_format($subtotal, 2, ',', '.')); ?></td>
          <td></td>
        </tr>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <tr class="grand-total-row">
        ...
        <td class="text-right"><strong>Rp&nbsp;<?php echo e(number_format($grandTotal, 2, ',', '.')); ?></strong></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="ttd">
    <div class="ttd-box">
      <div class="ttd-kota">Malang, <?php echo e(\Carbon\Carbon::parse($tanggal)->isoFormat('D MMMM YYYY')); ?></div>
  ...
  <div class="meta">
    Dicetak oleh: <?php echo e($generatedBy); ?> | <?php echo e($generatedAt->format('d/m/Y H:i:s')); ?> WIB
...
<?php /**PATH /Users/kharismamahanani/Downloads/treasury-laravel-5/resources/views/laporan/produk-pdf.blade.php ENDPATH**/ ?>