    ...
    <div style="overflow-x:auto">
      <table>
        <thead><tr>
          ...
          <th>Jatuh Tempo</th>
          <?php if(auth()->user()->canEdit()): ?> <th>Aksi</th> <?php endif; ?>
        </tr></thead>
...
const CAN_EDIT   = <?php echo e(auth()->user()->canEdit() ? 'true' : 'false'); ?>;
const IS_ADMIN   = <?php echo e(auth()->user()->isAdmin() ? 'true' : 'false'); ?>;
</script>
<script src="<?php echo e(asset('js/treasury.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/kharismamahanani/Downloads/treasury-laravel-5/resources/views/dashboard/index.blade.php ENDPATH**/ ?>